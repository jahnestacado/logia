    ...
    subscribeBusListeners: function(logger){
        bus.subscribe(BUSLINE_ID, {
            ...
            onLogToFile: function(msg, destFileOptions){
                fileAppender.log(msg, destFileOptions.fullFilePath);
            }
        });
    },
...
if(IN_SERVER_MODE){
    var LogFileTrimmer = require("./hermes-log-file-trimmer.js");
    ...
    UtilityBelt.logToFile = function(logger, formattedLogMsg){
        ...
        var destFileOptions = UtilityBelt.getLoggerRegexPropertyValue(loggerName, "destFile");
        destFileOptions.fullFilePath = fileAppender.getDestFileFullpath(destFileOptions.filepath);
        destFileOptions && bus[BUSLINE_ID].triggerLogToFile(formattedLogMsg, destFileOptions);
    };
