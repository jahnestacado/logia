...
var HermesLog = function (name) {
    ...
    var remoteLoggerInstanceConfig = hermesLog.getLoggerInstanceProperty("remote");
    hermesLog.remote = getHermesLogRemote(remoteLoggerInstanceConfig);
...
HermesLog.prototype.setLevel = function (newLogLevel) {
    ...
    hermesLog.setLoggerInstanceProperty("level", newLogLevel);
    hermesLog.updateActiveLevels();
};
...
HermesLog.prototype.setRemote = function (protocol, url) {
    ...
    hermesLog.setLoggerInstanceProperty("remote", {protocol: protocol, url: url});
    var loggerName = hermesLog.name;
...
HermesLog.prototype.updateActiveLevels = function () {
    ...
    var level = hermesLog.getLoggerInstanceProperty("level");
    var activeLevels = [];
    switch (level) {
        case "trace" :
...
HermesLog.prototype.log = function(logObject){
    var hermesLog = this;
    var formattedLogMsg = hermesLog.constructLogMessageHeader(hermesLog.name, logObject) + ": " + hermesLog.getParameterizedMessage(logObject);
    ...
    hermesLog.remote.log && hermesLog.remote.log(formattedLogMsg);
};
...
function getHermesLogRemote(remoteLoggerInstanceConfig){
    /*
