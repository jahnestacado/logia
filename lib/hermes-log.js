...
var UtilityBelt = {
    ...
    convertToString: function(value){
        var stringValue;
        if(IN_SERVER_MODE){
            stringValue = typeof value === "object" ?  UtilityBelt.toReadableStringOfDepthOne(value) : value.toString();
        } else {
    ...
    createLogMessageHeader: function (name, logObject) {
        ...
        return "(" + timestamp + ")"
                + " ["+ UtilityBelt.extendStringLength(logObject.level.toUpperCase(), LEVEL_NAME_MAX_LENGTH) + "]"
                + " {" + UtilityBelt.extendStringLength(name, LOGGER_NAME_MAX_LENGTH) + "}";
    },
