...
/**
* Enables slave mode. Logia configuration is dictated by the specified Logia master node.
* @param {string} url - Url that points to a running Logia master node
* @memberof Logia
*/
LogiaFactory.enterSlaveMode = function(options) {
    ...
    SLAVE_REMOTE.onWsMessage(function(config){
        delete config.mode;
