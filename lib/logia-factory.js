...
if(IN_SERVER_MODE){
    ...
    var LogServer = LogiaUtils.setupLogServer(null, RUNTIME_CONFIG, EVENT_BUSLINE);
    var LogFileTrimmer = require("./logia-file-trimmer.js");
    var LogFileTrimmer = new LogFileTrimmer(EVENT_BUSLINE);

    bus.subscribe(EVENT_BUSLINE, {
        afterConfigurationChanged: function () {
            LogServer = LogiaUtils.setupLogServer(LogServer, RUNTIME_CONFIG, EVENT_BUSLINE);
        }
    });
}
