...
var LogiaFullstackHandler = require("./logia-fullstack-handler.js")(BUSLINE_ID);
...
Logia.prototype._log = function(logSpecs){
    ...
    GLOBAL_CONFIG.stdout && bus[BUSLINE_ID].triggerLogToStdout(logObj.message, logObj.level);
