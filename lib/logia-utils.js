...
var LogiaUtils = {
    ...
    setupLogServer: function(logServer, config, eventBusline, listeners){
        ...
        var host = serverConfig.interface;
        var port = serverConfig.port;
        var hasDefaultConfiguration = (port === host) && port === null;
        if(serverConfig && !hasDefaultConfiguration){
    ...
    createLogMessage: function (logSpecs) {
        var logger  = this;
        var levelInfo = require("./logia-levels.js")[logSpecs.level];
